...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/ernazerkinbekov/PycharmProjects/wikidata'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/ernazerkinbekov/PycharmProjects/wikidata/bin/deactivate.nu'
